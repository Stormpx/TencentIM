...
public class BatchSendMsg extends GeneralModel {
    ...
    public BatchSendMsg(String serviceName) {
        super(serviceName);
    }
    ...
    public BatchSendMsg setSyncOtherMachine(Integer syncOtherMachine) {
    ...
    public BatchSendMsg setFrom_Account(String from_Account) {
    ...
    public BatchSendMsg setTo_Account(List<String> to_Account) {
    ...
    public BatchSendMsg setMsgRandom(Integer msgRandom) {
    ...
    public BatchSendMsg setMsgBody(List<TIMMsgElement> msgBody) {
    ...
    public BatchSendMsg setOfflinePushInfo(OfflinePushInfo offlinePushInfo) {
