...
public class ModifyGroupBaseInfo extends GeneralModel {
    ...
    public ModifyGroupBaseInfo(String serviceName) {
        super(serviceName);
    }
    ...
    public ModifyGroupBaseInfo setGroupId(String groupId) {
        this.groupId = groupId;return this;
    }

    public ModifyGroupBaseInfo setName(String name) {
        this.name = name;return this;
    }

    public ModifyGroupBaseInfo setIntroduction(String introduction) {
        this.introduction = introduction;return this;
    }

    public ModifyGroupBaseInfo setNotification(String notification) {
        this.notification = notification;return this;
    }

    public ModifyGroupBaseInfo setFaceUrl(String faceUrl) {
        this.faceUrl = faceUrl;return this;
    }

    public ModifyGroupBaseInfo setMaxMemberCount(Integer maxMemberCount) {
        this.maxMemberCount = maxMemberCount;return this;
    }

    public ModifyGroupBaseInfo setApplyJoinOption(String applyJoinOption) {
        this.applyJoinOption = applyJoinOption;return this;
    }

    public ModifyGroupBaseInfo setAppDefinedData(List<AppDefinedData> appDefinedData) {
        this.appDefinedData = appDefinedData;return this;
    }

    public ModifyGroupBaseInfo setAppDefinedData(AppDefinedData... appDefinedData) {
